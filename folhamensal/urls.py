...
from folhamensal.web.views.listar import FolhaMensalListView as FolhaMensalListView2
...
urlpatterns = [
    ...
    path("folha-mensal/list/", FolhaMensalListView2.as_view(), name="folha_mensal_listar"),
