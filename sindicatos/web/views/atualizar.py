...
class SindicatoTrabalhadoresUpdateView(SindicatoTrabalhadoresMixin, UpdateView):
    model = Sindicatos
    ...
    def get_object(self, queryset=None):
        ...
        qs = Sindicatos.objects.using(self.request.db_alias).filter(
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx["titulo"] = "Editar Sindicato Trabalhador"
        ctx["page_title"] = "Editar Sindicato Trabalhador"
    ...
    def form_valid(self, form):
        try:
            ...
            messages.success(self.request, "Sindicato trabalhador atualizado com sucesso.")
