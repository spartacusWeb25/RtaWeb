...
from sindicatos.services.logic import (
    SindicatoTrabalhadoresService,
    proximo_codigo_sindicato,
    _digits_only,
)


class SindicatoTrabalhadoresMixin(BancoObrigatorioMixin):
    ...
    def obter_nome_empresa_contexto(self, form=None):
        ...
        return SindicatoTrabalhadoresService.obter_nome_empresa(
    ...
    def obter_nome_filial_contexto(self, form=None):
        ...
        return SindicatoTrabalhadoresService.obter_nome_filial(
            banco=self.banco_limpo,
            db_alias=self.db_alias,
            codigo_empresa=empr,
            codigo_filial=fili,
